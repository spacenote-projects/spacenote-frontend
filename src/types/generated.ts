...
export type components = {
  schemas: {
    ...
    CreateNoteRequest: {
       ...
       *
       *     ⚠️ **Important**: All datetime values must be in UTC timezone. Timezone offsets (e.g., `+03:00`, `-05:00`) are not supported. All datetime values in responses are returned with `+00:00` suffix to indicate UTC (e.g., `2025-10-20T10:31:00+00:00`).
       *
       *     **Other field types**:
